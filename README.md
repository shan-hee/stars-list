...
| [XingHehy/netease-musician-task](https://github.com/XingHehy/netease-musician-task) | 网易云音乐自动签到发布动态、自动完成音乐人任务，支持自动登录、多用户、docker一键部署、WebHook通知 |
